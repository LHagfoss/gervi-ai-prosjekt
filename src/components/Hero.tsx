...
export default function Hero() {
  ...
  return (
    <section className="w-screen min-h-screen flex flex-col items-center">
      <div className="w-full relative min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-white to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <div className="flex flex-col items-center gap-6">
            ...
            <h1 className="text-6xl md:text-9xl leading-[50%] font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800">
              OmniGen
            </h1>
            ...
            <div className="flex items-center gap-4 text-sm text-blue-900 mt-4 bg-white/60 backdrop-blur-sm px-6 py-3 rounded-full shadow-md">
