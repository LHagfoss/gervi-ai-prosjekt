...
export default function Portfolio() {
  ...
  return (
    <section ref={portfolioRef} className="w-full py-20 bg-linear-to-br from-zinc-50 to-white relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            <div key={item} className="portfolio-item group">
              <div className="relative overflow-hidden rounded-2xl bg-white/70 backdrop-blur-md shadow-lg hover:-translate-y-2 transition-all duration-300">
                <div className="h-64 bg-blue-100/50 relative">
                  <div className="absolute inset-0 bg-linear-to-t from-blue-900/90 via-blue-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
        ...
        <div className="text-center mt-12">
          <button className="bg-blue-600/90 backdrop-blur-xs hover:bg-blue-700 text-white px-8 py-3 rounded-lg text-lg font-semibold transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            View All Projects
          </button>
        </div>
      </div>
